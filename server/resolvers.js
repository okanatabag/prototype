const products = [
	...
	{
		id: 2,
		title: "Xiaomi Jimmy Jv83 Dikey Şarjlı Süpürge 450W (Distribütör Garantili) 25.2 Volt",
	...
	{
		id: 4,
		title: 'Samsung 50Q60T 50" 127 Ekran Uydu Alıcılı 4K Ultra HD Smart QLED TV-(OUTLET ÜRÜN)',
...
const getFavoriteProducts = () =>
	Promise.resolve(products.filter((product) => product.favorite === true));

const setFavoriteState = ({ productId }) => {
	const index = products.findIndex((product) => product.id === productId);
	const stateOfFoundProduct = products[index].favorite;
...
module.exports = {
	...
	Mutation: {
		setFavoriteState: async (_, { id }) =>
			setFavoriteState({ productId: id }),
	},
};
